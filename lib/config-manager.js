	...
	load() {
		try {
			...
			if (fs.existsSync(this.configPath)) {
				...
				console.log(`[External Notify] Loaded config for user ${this.client.name}`);
		...
		console.log(`[External Notify] No config found for user ${this.client.name}, using defaults`);
